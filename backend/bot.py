...
def send_instagram_direct(image_bytes, name, category):
    """
    Graph API ಬಳಸಿ Instagram ಗೆ ಡೈರೆಕ್ಟ್ ಆಗಿ ಪೋಸ್ಟ್ ಮಾಡುವ ವಿಧಾನ.
    """
    ...
    try:
        ...
        image_url = (
            ...
            f"?width=768&height=1024&seed=42&nologo=true&model=flux"
        )
        ...
        if not container_id:
            # ✅ FIX 1: Added missing comma between string and variable
            print("❌ ಮೀಡಿಯಾ ಕಂಟೈನರ್ ಕ್ರಿಯೇಟ್ ಮಾಡ ಸಾಧ್ಯವಾಗಲಿಲ್ಲ:", response)
            return False
    ...
    try:
        ...
        if is_direct:
            ...
            try:
                ...
                prompt = (
                    'Analyze this women\'s clothing photo. Respond ONLY in JSON:\n'
                    '{\n'
                    '  "name": "product name",\n'
                    '  "category": "Sets",\n'
                ...
                response = model.generate_content([
                    "Provide product name, category, and description in JSON format matching women clothing.",
                    image_pil
                ])
                response_text = response.text.strip()
            ...
            try:
                ...
                # ✅ FIX 2: pollinations_url kept on one logical line using parentheses
                pollinations_url = (
                    f"https://image.pollinations.ai/prompt/{formatted_prompt}"
                    f"?width=768&height=1024&seed=42&nologo=true&model=flux"
                )
        ...
        if upload.status_code in [200, 201]:
            ...
            status_msg = "✅ Website Upload successful!\n"
